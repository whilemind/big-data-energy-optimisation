...
function run_postprocess()
    ...
    methods = [
                ...
                struct('name', "collect_good_reel_by_grade_code", 'func', @collect_good_reel_scale, 'run', 1, 'desc', "This is function is to generate all the good reel data to mat file")...
              ];
